...
exports.parseJavascript = function (config, full_path) {
  return new Promise(function (resolve, reject) {
    ...
    loadJavascript(full_path, config.babel, function (err, result) {
      ...
      concat.add(
        null,
        `define("${full_path}", function(require, module, exports, Promise, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,WeixinJSBridge,Reporter){`
      )
