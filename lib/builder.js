...
function concatFiles(obj, pages) {//连接所有编译后的js
  cache.set('codes', obj)
  ...
  return concat.content.toString().replace(/WeixinJSBridge/g,'ServiceJSBridge').replace(/([^a-zA-Z/])wx\./g,'$1wd.').replace(/Object\.defineProperty\(\s*wx\s*,/g,'Object.defineProperty(wd,').replace(/([^a-zA-Z/])Reporter/g,'$1SReporter')
}
